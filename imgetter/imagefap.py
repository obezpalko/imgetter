...
from .tools import get_attr, USER_AGENT, ImageSite, get_page, get_file_name, save_file, printProgressBar
...
if __name__ == '__main__':
    ...
    try:
        ...
        album_page = 'https://www.imagefap.com/gallery.php?gid=1558558&gen='
